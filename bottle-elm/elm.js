...
Elm.Main.make = function (_elm) {
   ...
   var menu = A2($Html.div,
   _L.fromArray([$Html$Attributes.$class("menu")]),
   _L.fromArray([$Html.text("menu")]));
   var displayUser = F2(function (user,
   _v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                 var h = $Basics.round(435 / 2 - 120 / 2) + 40;
                 var w = $Basics.round(750 / 2 - 80 / 2) + 10;
                 return A2($Html.div,
                 _L.fromArray([$Html$Attributes.$class("user_div")
                              ,$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                    ,_0: "left"
                                                                    ,_1: A2($Basics._op["++"],
                                                                    $Basics.toString(w + _v0._0),
                                                                    "px")}
                                                                   ,{ctor: "_Tuple2"
                                                                    ,_0: "top"
                                                                    ,_1: A2($Basics._op["++"],
                                                                    $Basics.toString(h + _v0._1),
                                                                    "px")}]))]),
                 _L.fromArray([A2($Html.div,
                              _L.fromArray([$Html$Attributes.$class("user_name")]),
                              _L.fromArray([$Html.text(user.name)]))
                              ,A2($Html.div,
                              _L.fromArray([$Html$Attributes.$class("user_img_div")]),
                              _L.fromArray([A2($Html.img,
                              _L.fromArray([$Html$Attributes.$class("user_img")
                                           ,$Html$Attributes.src(user.photo)]),
                              _L.fromArray([]))]))
                              ,A2($Html.div,
                              _L.fromArray([$Html$Attributes.$class("user_phrase")]),
                              _L.fromArray([$Html.text(user.message)]))
                              ,A2($Html.img,
                              _L.fromArray([$Html$Attributes.$class("user_gift")
                                           ,$Html$Attributes.src("resources/gifts/eat/1.png")]),
                              _L.fromArray([]))]));
              }();}
         _U.badCase($moduleName,
   ...
   var displayUserWithPos = function (_v4) {
      return function () {
         switch (_v4.ctor)
         {case "_Tuple2":
            return function () {
   ...
   var inputText = A2($Html.input,
   _L.fromArray([$Html$Attributes.$class("text_input")
                ,$Html$Attributes.placeholder("Введите сообщение")
                ,$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                      ,_0: "type"
                                                      ,_1: "text"}]))]),
   _L.fromArray([]));
   var toNeg = function (x) {
      return 0 - x;
   };
   var yPositions = _L.fromArray([145
                                 ,130
                                 ,70]);
   var xPositions = _L.fromArray([57
                                 ,175
                                 ,290]);
   var usersPositions = A2($Basics._op["++"],
   A3($List.map2,
   F2(function (v0,v1) {
      return {ctor: "_Tuple2"
             ,_0: v0
   ...
   toNeg,
   yPositions)))));
   var usersPositions10 = _L.fromArray([{ctor: "_Tuple2"
                                        ,_0: -280
                                        ,_1: 80}
                                       ,{ctor: "_Tuple2"
                                        ,_0: -140
                                        ,_1: 130}
                                       ,{ctor: "_Tuple2",_0: 0,_1: 145}
                                       ,{ctor: "_Tuple2"
                                        ,_0: 140
                                        ,_1: 130}
                                       ,{ctor: "_Tuple2"
   ...
   700,
   game);
   var test1 = A2($Signal.map,
   $Text.asText,
   $Signal.constant("Hello"));
   _elm.Main.values = {_op: _op
                      ,test1: test1
                      ,main: main
                      ,usersPositions10: usersPositions10
                      ...
                      ,table: table
                      ,inputText: inputText
                      ,displayUserWithPos: displayUserWithPos
...
Elm.Model.make = function (_elm) {
   ...
   var None = {ctor: "None"};
   var TableUser = function (a) {
      return {ctor: "TableUser"
             ,_0: a};
   };
...
Elm.Test.make = function (_elm) {
   ...
   $moduleName = "Test",
   $Model = Elm.Model.make(_elm);
   var users = _L.fromArray([$Model.TableUser({_: {}
                                              ,id: 1
                                              ,message: "Привет, как дела? Я классный!"
                                              ,name: "George"
                                              ,photo: "http://cs315926.vk.me/v315926369/56f4/6j9VFPV-W3I.jpg"})
                            ,$Model.TableUser({_: {}
                                              ,id: 2
                                              ,message: ""
                                              ,name: "Nicky"
                                              ,photo: "http://cs9925.vk.me/u121802689/a_1d4aa029.jpg"})
                            ,$Model.TableUser({_: {}
                                              ,id: 3
                                              ,message: "Помолчи ;) Ты все уже достал!! Хахах!"
                                              ,name: "Engy"
                                              ,photo: "https://pp.vk.me/c320130/v320130987/6a36/zRJ7ysYChVk.jpg"})
                            ,$Model.TableUser({_: {}
                                              ,id: 1
                                              ,message: "Hello, workld"
                                              ,name: "TGasdfT"
                                              ,photo: "http://cs5914.vk.me/u108581826/a_e9220377.jpg"})
                            ,$Model.TableUser({_: {}
                                              ,id: 2
                                              ,message: "Всем привет)"
                                              ,name: "Michael"
                                              ,photo: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcRDejNfkLl7ILlvkUu9cxGCDVRnX5be8sUq-t3-Y1wz-RFSvJnG0w"})
                            ,$Model.TableUser({_: {}
                                              ,id: 3
                                              ,message: "скорей пишите но предупреждаю у меня есть дама"
                                              ,name: "Dio"
                                              ,photo: "http://cs416117.vk.me/v416117839/41c0/mlQGI5mxwIU.jpg"})
                            ,$Model.TableUser({_: {}
                                              ,id: 1
                                              ,message: ""
                                              ,name: "Nina"
                                              ,photo: "http://cs301413.vk.me/v301413265/d95/R3_4f6q-JM0.jpg"})
                            ,$Model.TableUser({_: {}
                                              ,id: 2
                                              ,message: "Всем привет)"
                                              ,name: "Nicky"
                                              ,photo: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcRuBc9bxBoUUbYtvwT_nGuB6DmvovFW4YFbxdVyhBk6sjlWH_q4"})
                            ,$Model.TableUser({_: {}
                                              ,id: 3
                                              ,message: "В Российской Федерации обнаружены полезные ископаемые!"
                                              ,name: "Инга"
                                              ,photo: "http://cs416918.vk.me/v416918600/1772/2kVAaoMEeMk.jpg"})
                            ,$Model.TableUser({_: {}
                                              ,id: 1
                                              ,message: ""
                                              ,name: "Georgy"
                                              ,photo: "http://cs9224.vk.me/u57176780/a_286df639.jpg"})
                            ,$Model.TableUser({_: {}
                                              ,id: 2
                                              ,message: "Hoho"
                                              ,name: "Pipo"
                                              ,photo: "http://cs207.vk.me/u43515624/a_d18263fb.jpg"})
                            ,$Model.TableUser({_: {}
                                              ,id: 3
                                              ,message: ";)"
                                              ,name: "Engyrgg"
                                              ,photo: "http://cs417030.vk.me/v417030365/5520/FcSre_MHICc.jpg"})]);
