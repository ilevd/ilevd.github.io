...
Elm.Model.make = function (_elm) {
   ...
   var FriendWindow = function (a) {    return {ctor: "FriendWindow",_0: a};};
   var NoneGroup = {ctor: "NoneGroup"};
   var GroupWindow = function (a) {    return {ctor: "GroupWindow",_0: a};};
   var None = {ctor: "None"};
   var Window = F2(function (a,b) {    return {ctor: "Window",_0: a,_1: b};});
   var User = F4(function (a,b,c,d) {    return {id: a,first_name: b,last_name: c,photo: d};});
   var Audio = F4(function (a,b,c,d) {    return {id: a,owner_id: b,title: c,artist: d};});
   var Photo = F7(function (a,b,c,d,e,f,g) {    return {id: a,owner_id: b,photo_75: c,photo_130: d,photo_604: e,width: f,height: g};});
   var Post = F7(function (a,b,c,d,e,f,g) {    return {id: a,text: b,likes: c,date: d,date_str: e,photos: f,audios: g};});
   var Group = F7(function (a,b,c,d,e,f,g) {    return {id: a,name: b,screen_name: c,is_closed: d,photo_50: e,photo_100: f,photo_200: g};});
...
Elm.Utils.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var getNext2 = F4(function (all,list,f,elem) {
      getNext2: while (true) {
         var _p0 = list;
         if (_p0.ctor === "[]") {
               return "";
               ...
               var _p3 = _p0._1;
               if (_U.eq(f(_p0._0),elem)) {
                     var _p1 = _p3;
                     if (_p1.ctor === "::") {
                           return f(_p1._0);
                        } else {
                           var _p2 = $List.head(all);
                           if (_p2.ctor === "Just") {
                                 return f(_p2._0);
                              } else {
                                 return "";
                     ...
                     var _v3 = all,_v4 = _p3,_v5 = f,_v6 = elem;
                     all = _v3;
                     list = _v4;
                     f = _v5;
                     elem = _v6;
   ...
   var divideList = F5(function (posts1,posts2,posts3,posts,acc) {
      var _p4 = posts;
      if (_p4.ctor === "[]") {
            return {ctor: "_Tuple3",_0: posts1,_1: posts2,_2: posts3};
         } else {
            var _p7 = _p4._0;
            var _p5 = A5(divideList,posts1,posts2,posts3,_p4._1,acc + 1);
            var p1 = _p5._0;
            var p2 = _p5._1;
            var p3 = _p5._2;
            var _p6 = A2($Basics._op["%"],acc,3);
            switch (_p6)
            {case 0: return {ctor: "_Tuple3",_0: A2($List._op["::"],_p7,p1),_1: p2,_2: p3};
               case 1: return {ctor: "_Tuple3",_0: p1,_1: A2($List._op["::"],_p7,p2),_2: p3};
               case 2: return {ctor: "_Tuple3",_0: p1,_1: p2,_2: A2($List._op["::"],_p7,p3)};
               default: return {ctor: "_Tuple3",_0: p1,_1: p2,_2: p3};}
         }
   });
   return _elm.Utils.values = {_op: _op,divideList: divideList,getNext2: getNext2};
};
...
Elm.Update.make = function (_elm) {
   ...
   var update = F2(function (action,state) {
      ...
      {case "Noop": return state;
         case "NewGroups": var _p2 = _p0._0;
           var _p1 = _p2;
           if (_p1.ctor === "::") {
                 return _U.update(state,{groups: _p2,currentGroup: _p1._0.id,openPosts: _U.list([])});
              } else {
                 return _U.update(state,{groups: _p1,openPosts: _U.list([]),posts: _U.list([])});
              }
         case "ChangeGroup": return _U.update(state,{posts: _U.list([]),openPosts: _U.list([]),currentGroup: _p0._0});
         case "GetPosts": var _p4 = _p0._0;
           var _p3 = state.posts;
           if (_p3.ctor === "[]") {
                 return _U.update(state,{posts: _p4});
              } else {
                 return _U.update(state,{posts: A2($Basics._op["++"],_p3,_p4)});
              }
         case "ClickText": var _p6 = _p0._0;
           var _p5 = A2($List.filter,function (id) {    return _U.eq(id,_p6);},state.openPosts);
           if (_p5.ctor === "[]") {
                 return _U.update(state,{openPosts: A2($Basics._op["++"],_U.list([_p6]),state.openPosts)});
              } else {
                 return _U.update(state,{openPosts: A2($List.filter,function (id) {    return !_U.eq(id,_p6);},state.openPosts)});
              }
         case "ChangeToggle": return _U.update(state,{openPosts: _U.list([]),posts: _U.list([]),currentToggle: _p0._0});
         case "OpenImage": return _U.update(state,{postWindow: _p0._0});
         case "Resize": return _U.update(state,{winSize: {ctor: "_Tuple2",_0: _p0._0._0,_1: _p0._0._1}});
         case "Repost": return state;
         case "OpenFriendWindow": return _U.update(state,{friendWindow: _p0._0});
         case "OpenGroupWindow": return _U.update(state,{groupWindow: _p0._0});
         case "SetFriends": return _U.update(state,{friends: _p0._0});
         default: return _U.update(state,{postGroups: _p0._0});}
   });
   var Repost = F2(function (a,b) {    return {ctor: "Repost",_0: a,_1: b};});
   var Resize = function (a) {    return {ctor: "Resize",_0: a};};
   var NewGroups = function (a) {    return {ctor: "NewGroups",_0: a};};
   var SetGroups = function (a) {    return {ctor: "SetGroups",_0: a};};
   var SetFriends = function (a) {    return {ctor: "SetFriends",_0: a};};
   var OpenGroupWindow = function (a) {    return {ctor: "OpenGroupWindow",_0: a};};
   var OpenFriendWindow = function (a) {    return {ctor: "OpenFriendWindow",_0: a};};
   var OpenImage = function (a) {    return {ctor: "OpenImage",_0: a};};
   var ClickText = function (a) {    return {ctor: "ClickText",_0: a};};
   var ChangeGroup = function (a) {    return {ctor: "ChangeGroup",_0: a};};
   var ChangeToggle = function (a) {    return {ctor: "ChangeToggle",_0: a};};
   var GetPosts = function (a) {    return {ctor: "GetPosts",_0: a};};
   var Noop = {ctor: "Noop"};
...
Elm.Nicepost.make = function (_elm) {
   ...
   if (_elm.Nicepost.values) return _elm.Nicepost.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   function (v) {
      return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
         return typeof v === "object" && "id" in v && "first_name" in v && "last_name" in v && "photo" in v ? {_: {}
                                                                                                              ...
                                                                                                              v.id)
                                                                                                              ,first_name: typeof v.first_name === "string" || typeof v.first_name === "object" && v.first_name instanceof String ? v.first_name : _U.badPort("a string",
                                                                                                              v.first_name)
                                                                                                              ,last_name: typeof v.last_name === "string" || typeof v.last_name === "object" && v.last_name instanceof String ? v.last_name : _U.badPort("a string",
                                                                                                              v.last_name)
                                                                                                              ,photo: typeof v.photo === "string" || typeof v.photo === "object" && v.photo instanceof String ? v.photo : _U.badPort("a string",
                                                                                                              v.photo)} : _U.badPort("an object with fields `id`, `first_name`, `last_name`, `photo`",
         v);
      })) : _U.badPort("an array",v);
   });
   var newFriends = function () {
      var convert = function (friends) {    return $Update.SetFriends(friends);};
      return A2($Signal.map,convert,getPostFriends);
   }();
   var getPostGroups = Elm.Native.Port.make(_elm).inboundSignal("getPostGroups",
   "List Model.Group",
   function (v) {
      return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
         return typeof v === "object" && "id" in v && "name" in v && "screen_name" in v && "is_closed" in v && "photo_50" in v && "photo_100" in v && "photo_200" in v ? {_: {}
                                                                                                                                                                         ...
                                                                                                                                                                         v.name)
                                                                                                                                                                         ,screen_name: typeof v.screen_name === "string" || typeof v.screen_name === "object" && v.screen_name instanceof String ? v.screen_name : _U.badPort("a string",
                                                                                                                                                                         v.screen_name)
                                                                                                                                                                         ,is_closed: typeof v.is_closed === "number" && isFinite(v.is_closed) && Math.floor(v.is_closed) === v.is_closed ? v.is_closed : _U.badPort("an integer",
                                                                                                                                                                         v.is_closed)
                                                                                                                                                                         ,photo_50: typeof v.photo_50 === "string" || typeof v.photo_50 === "object" && v.photo_50 instanceof String ? v.photo_50 : _U.badPort("a string",
                                                                                                                                                                         v.photo_50)
                                                                                                                                                                         ,photo_100: typeof v.photo_100 === "string" || typeof v.photo_100 === "object" && v.photo_100 instanceof String ? v.photo_100 : _U.badPort("a string",
                                                                                                                                                                         v.photo_100)
                                                                                                                                                                         ,photo_200: typeof v.photo_200 === "string" || typeof v.photo_200 === "object" && v.photo_200 instanceof String ? v.photo_200 : _U.badPort("a string",
                                                                                                                                                                         v.photo_200)} : _U.badPort("an object with fields `id`, `name`, `screen_name`, `is_closed`, `photo_50`, `photo_100`, `photo_200`",
         v);
      })) : _U.badPort("an array",v);
   });
   var newPostGrpous = function () {
      var convert = function (groups) {    return $Update.SetGroups(groups);};
      return A2($Signal.map,convert,getPostGroups);
   }();
   var resize = Elm.Native.Port.make(_elm).inboundSignal("resize",
   "( Int, Int )",
   function (v) {
   ...
   var newResize = A2($Signal.map,$Update.Resize,resize);
   var getWallPosts = Elm.Native.Port.make(_elm).inboundSignal("getWallPosts",
   "( Int, List Model.Post )",
   function (v) {
      return typeof v === "object" && v instanceof Array ? {ctor: "_Tuple2"
                                                           ,_0: typeof v[0] === "number" && isFinite(v[0]) && Math.floor(v[0]) === v[0] ? v[0] : _U.badPort("an integer",
                                                           ...
                                                           ,_1: typeof v[1] === "object" && v[1] instanceof Array ? Elm.Native.List.make(_elm).fromArray(v[1].map(function (v) {
                                                              return typeof v === "object" && "id" in v && "text" in v && "likes" in v && "date" in v && "date_str" in v && "photos" in v && "audios" in v ? {_: {}
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             v.text)
                                                                                                                                                                                                             ,likes: typeof v.likes === "number" && isFinite(v.likes) && Math.floor(v.likes) === v.likes ? v.likes : _U.badPort("an integer",
                                                                                                                                                                                                             v.likes)
                                                                                                                                                                                                             ,date: typeof v.date === "number" ? v.date : _U.badPort("a number",
                                                                                                                                                                                                             v.date)
                                                                                                                                                                                                             ,date_str: typeof v.date_str === "string" || typeof v.date_str === "object" && v.date_str instanceof String ? v.date_str : _U.badPort("a string",
                                                                                                                                                                                                             v.date_str)
                                                                                                                                                                                                             ,photos: typeof v.photos === "object" && v.photos instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.photos.map(function (v) {
                                                                                                                                                                                                                return typeof v === "object" && "id" in v && "owner_id" in v && "photo_75" in v && "photo_130" in v && "photo_604" in v && "width" in v && "height" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                           ,id: typeof v.id === "number" && isFinite(v.id) && Math.floor(v.id) === v.id ? v.id : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                           v.id)
                                                                                                                                                                                                                                                                                                                                                                           ,owner_id: typeof v.owner_id === "number" && isFinite(v.owner_id) && Math.floor(v.owner_id) === v.owner_id ? v.owner_id : _U.badPort("an integer",
                                                                                                                                                                                                                                                                                                                                                                           v.owner_id)
                                                                                                                                                                                                                                                                                                                                                                           ,photo_75: typeof v.photo_75 === "string" || typeof v.photo_75 === "object" && v.photo_75 instanceof String ? v.photo_75 : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                           v.photo_75)
                                                                                                                                                                                                                                                                                                                                                                           ,photo_130: typeof v.photo_130 === "string" || typeof v.photo_130 === "object" && v.photo_130 instanceof String ? v.photo_130 : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                           v.photo_130)
                                                                                                                                                                                                                                                                                                                                                                           ,photo_604: typeof v.photo_604 === "string" || typeof v.photo_604 === "object" && v.photo_604 instanceof String ? v.photo_604 : _U.badPort("a string",
                                                                                                                                                                                                                                                                                                                                                                           v.photo_604)
                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                           v.height)} : _U.badPort("an object with fields `id`, `owner_id`, `photo_75`, `photo_130`, `photo_604`, `width`, `height`",
                                                                                                                                                                                                                v);
                                                                                                                                                                                                             })) : _U.badPort("an array",
                                                                                                                                                                                                             v.photos)
                                                                                                                                                                                                             ,audios: typeof v.audios === "object" && v.audios instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.audios.map(function (v) {
                                                                                                                                                                                                                return typeof v === "object" && "id" in v && "owner_id" in v && "title" in v && "artist" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                v.artist)} : _U.badPort("an object with fields `id`, `owner_id`, `title`, `artist`",
                                                                                                                                                                                                                v);
                                                                                                                                                                                                             })) : _U.badPort("an array",
                                                                                                                                                                                                             v.audios)} : _U.badPort("an object with fields `id`, `text`, `likes`, `date`, `date_str`, `photos`, `audios`",
                                                              v);
                                                           })) : _U.badPort("an array",v[1])} : _U.badPort("an array",v);
   });
   var newPosts = function () {
      var convert = function (_p0) {    var _p1 = _p0;return $Update.GetPosts(_p1._1);};
      return A2($Signal.map,convert,getWallPosts);
   }();
   var getGroups = Elm.Native.Port.make(_elm).inboundSignal("getGroups",
   "List Model.Group",
   function (v) {
      return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
         return typeof v === "object" && "id" in v && "name" in v && "screen_name" in v && "is_closed" in v && "photo_50" in v && "photo_100" in v && "photo_200" in v ? {_: {}
   ...
   var newGroups = A2($Signal.map,$Update.NewGroups,getGroups);
   var actions = $Signal.mailbox($Update.Noop);
   var htmlGroupClick = Elm.Native.Port.make(_elm).outboundSignal("htmlGroupClick",
   function (v) {
      return v;
   },
   function () {
      var select = function (act) {
         var _p2 = act;
      ...
      return A2($Signal.map,select,A3($Signal.filter,pridicate,$Update.ChangeGroup(0),actions.signal));
   }());
   var htmlToggleClick = Elm.Native.Port.make(_elm).outboundSignal("htmlToggleClick",
   function (v) {
      return v;
   },
   function () {
      ...
      return A2($Signal.map,select,A3($Signal.filter,predicate,$Update.ChangeToggle("Юмор"),actions.signal));
   }());
   var repostClick = Elm.Native.Port.make(_elm).outboundSignal("repostClick",
   function (v) {
      return [{id: v._0.id
              ,text: v._0.text
              ,likes: v._0.likes
              ...
              ,photos: Elm.Native.List.make(_elm).toArray(v._0.photos).map(function (v) {
                 return {id: v.id,owner_id: v.owner_id,photo_75: v.photo_75,photo_130: v.photo_130,photo_604: v.photo_604,width: v.width,height: v.height};
              })
              ,audios: Elm.Native.List.make(_elm).toArray(v._0.audios).map(function (v) {
                 return {id: v.id,owner_id: v.owner_id,title: v.title,artist: v.artist};
              })}
             ,v._1];
   },
   function () {
      ...
      return A2($Signal.map,select,A3($Signal.filter,predicate,A2($Update.Repost,emptyPost,0),actions.signal));
   }());
   var mainSignal = $Signal.mergeMany(_U.list([actions.signal,newGroups,newPosts,newResize,newPostGrpous,newFriends]));
   var defaultState = {currentToggle: "Юмор"
                      ,currentGroup: 0
                      ,groups: _U.list([])
                      ,posts: _U.list([])
                      ,openPosts: _U.list([])
                      ...
                      ,postGroups: _U.list([])
                      ,winSize: {ctor: "_Tuple2",_0: 1000,_1: 0}};
   var currentState = A3($Signal.foldp,$Update.update,defaultState,mainSignal);
   var getToggle = F2(function (theme,name) {
      var className = _U.eq(name,theme) ? "toggle-btn toggle-btn-checked" : "toggle-btn toggle-btn-normal";
      return A2($Html.div,
      _U.list([$Html$Attributes.$class(className),A2($Html$Events.onClick,actions.address,$Update.ChangeToggle(name))]),
      _U.list([$Html.text(name)]));
   });
   var displayToggles = F2(function (toggles,theme) {
      return A2($Html.div,_U.list([$Html$Attributes.$class("main-toggle")]),A2($List.map,getToggle(theme),toggles));
   });
   var toggleList = _U.list(["Юмор"
                            ,"Любовь"
                            ,"Новости"
                            ,"IT"
                            ,"Картинки"
                            ...
                            ,"Рукоделие"
                            ,"Мои"]);
   var groupImg = F2(function (currentGroup,group) {
      var cls = _U.eq(group.id,currentGroup) ? "group_checked" : "groupimg";
      return A2($Html.img,
      _U.list([$Html$Attributes.$class(cls)
              ,$Html$Attributes.src(group.photo_50)
              ,$Html$Attributes.title(A2($Basics._op["++"],group.name,A2($Basics._op["++"]," | ",group.screen_name)))
              ,A2($Html$Events.onClick,actions.address,$Update.ChangeGroup(group.id))]),
      _U.list([]));
   });
   var groupsDiv = F2(function (groups,currentGroup) {
      return A2($Html.div,_U.list([$Html$Attributes.$class("groups")]),A2($List.map,groupImg(currentGroup),groups));
   });
   var displayLoader = A2($Html.img,
   _U.list([$Html$Attributes.src("resources/loader.gif")
           ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "marginLeft",_1: "455px"},{ctor: "_Tuple2",_0: "marginTop",_1: "200px"}]))]),
   _U.list([]));
   var postFooter = function (post) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("footer")]),
      _U.list([A2($Html.span,_U.list([$Html$Attributes.$class("date")]),_U.list([$Html.text(post.date_str)]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("postbutton"),A2($Html$Events.onClick,actions.address,A2($Update.Repost,post,0))]),
              _U.list([$Html.text("На стену")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("postbutton"),A2($Html$Events.onClick,actions.address,$Update.OpenFriendWindow($Model.FriendWindow(post)))]),
              _U.list([$Html.text("Друзьям")]))
              ,A2($Html.span,_U.list([$Html$Attributes.$class("likes")]),_U.list([$Html.text($Basics.toString(post.likes))]))]));
   };
   var getAudio = F2(function (post,audio) {
      return A2($Html.a,
      _U.list([$Html$Attributes.$class("song"),A2($Html$Events.onClick,actions.address,A2($Update.Repost,post,0))]),
   ...
   var postColumn = F3(function (name,posts,openPosts) {
      return A2($Html.div,_U.list([$Html$Attributes.$class("columnpost"),$Html$Attributes.id(name)]),A2($List.map,postHtml(openPosts),posts));
   });
   var getGroupLine = F2(function (post,group) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("friend_item"),A2($Html$Events.onClick,actions.address,A2($Update.Repost,post,0 - group.id))]),
   ...
   var getGroupWindow = F3(function (_p14,groups,post) {
      ...
      _U.list([A2($Html.p,
              _U.list([$Html$Attributes.$class("post_window_p")]),
              _U.list([A2($Html.a,
              _U.list([$Html$Attributes.$class("close"),A2($Html$Events.onClick,actions.address,$Update.OpenGroupWindow($Model.NoneGroup))]),
              _U.list([$Html.text("Закрыть")]))]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("friend_container")]),A2($List.map,getGroupLine(post),groups))]))]));
   });
   var getFriendLine = F2(function (post,user) {
      return A2($Html.span,
      _U.list([$Html$Attributes.$class("friend_item"),A2($Html$Events.onClick,actions.address,A2($Update.Repost,post,user.id))]),
      _U.list([A2($Html.img,_U.list([$Html$Attributes.$class("friend_img"),$Html$Attributes.src(user.photo)]),_U.list([]))
              ,A2($Html.a,
   ...
   var getFriendsWindow = F4(function (_p16,friends,groups,post) {
      ...
      _U.list([A2($Html.p,
              _U.list([$Html$Attributes.$class("post_window_p")]),
              _U.list([A2($Html.a,
              _U.list([$Html$Attributes.$class("close"),A2($Html$Events.onClick,actions.address,$Update.OpenFriendWindow($Model.NoneFriend))]),
              _U.list([$Html.text("Закрыть")]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("friend_container")]),
              A2($Basics._op["++"],A2($List.map,getGroupLine(post),groups),A2($List.map,getFriendLine(post),friends)))]))]));
   });
   ...
   var getPostWindow = F3(function (_p18,post,imgSrc) {
      ...
      _U.list([A2($Html.p,
              _U.list([$Html$Attributes.$class("post_window_p")]),
              _U.list([A2($Html.a,
              _U.list([$Html$Attributes.$class("close"),A2($Html$Events.onClick,actions.address,$Update.OpenImage($Model.None))]),
              _U.list([$Html.text("Закрыть")]))]))
              ,A2($Html.img,A2($Basics._op["++"],_U.list([$Html$Attributes.$class("win_img"),$Html$Attributes.src(imgSrc)]),imgStyle),_U.list([]))]))]));
   });
   ...
   var postColumns = F2(function (posts,openPosts) {
      ...
      if (_p20.ctor === "[]") {
            ...
            _U.list([A3(postColumn,"post-column1",posts1,openPosts)
                    ,A3(postColumn,"post-column2",posts2,openPosts)
   ...
   return _elm.Nicepost.values = {_op: _op
