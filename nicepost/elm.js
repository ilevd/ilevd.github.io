...
Elm.Nicepost.make = function (_elm) {
   ...
   var emptyPost = {_: {}
                   ...
                   ,photos: _L.fromArray([])
                   ,text: ""};
   var getPostFriends = _P.portIn("getPostFriends",
   ...
   var getPostGroups = _P.portIn("getPostGroups",
   _P.incomingSignal(function (v) {
      return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
         return typeof v === "object" && "id" in v && "name" in v && "screen_name" in v && "is_closed" in v && "photo_50" in v && "photo_100" in v && "photo_200" in v ? {_: {}
                                                                                                                                                                         ...
                                                                                                                                                                         v.screen_name)
                                                                                                                                                                         ,is_closed: typeof v.is_closed === "number" ? v.is_closed : _U.badPort("a number",
                                                                                                                                                                         v.is_closed)
   ...
   var newResize = A2($Signal.map,
   $Update.Resize,
   resize);
   var getWallPosts = _P.portIn("getWallPosts",
   _P.incomingSignal(function (v) {
      return typeof v === "object" && v instanceof Array ? {ctor: "_Tuple2"
                                                           ,_0: typeof v[0] === "number" ? v[0] : _U.badPort("a number",
                                                           v[0])
                                                           ,_1: typeof v[1] === "object" && v[1] instanceof Array ? Elm.Native.List.make(_elm).fromArray(v[1].map(function (v) {
                                                              return typeof v === "object" && "id" in v && "text" in v && "likes" in v && "date" in v && "date_str" in v && "photos" in v && "audios" in v ? {_: {}
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             v.text)
                                                                                                                                                                                                             ,likes: typeof v.likes === "number" ? v.likes : _U.badPort("a number",
                                                                                                                                                                                                             v.likes)
                                                                                                                                                                                                             ...
                                                                                                                                                                                                             ,photos: typeof v.photos === "object" && v.photos instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.photos.map(function (v) {
                                                                                                                                                                                                                return typeof v === "object" && "id" in v && "owner_id" in v && "photo_75" in v && "photo_130" in v && "photo_604" in v && "width" in v && "height" in v ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                           ,id: typeof v.id === "number" ? v.id : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                           v.id)
                                                                                                                                                                                                                                                                                                                                                                           ,owner_id: typeof v.owner_id === "number" ? v.owner_id : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                           v.owner_id)
                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                           v.photo_604)
                                                                                                                                                                                                                                                                                                                                                                           ,width: typeof v.width === "number" ? v.width : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                           v.width)
                                                                                                                                                                                                                                                                                                                                                                           ,height: typeof v.height === "number" ? v.height : _U.badPort("a number",
   ...
   var getGroups = _P.portIn("getGroups",
   _P.incomingSignal(function (v) {
      return typeof v === "object" && v instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.map(function (v) {
         return typeof v === "object" && "id" in v && "name" in v && "screen_name" in v && "is_closed" in v && "photo_50" in v && "photo_100" in v && "photo_200" in v ? {_: {}
                                                                                                                                                                         ,id: typeof v.id === "number" ? v.id : _U.badPort("a number",
   ...
   var newGroups = A2($Signal.map,
   $Update.NewGroups,
   getGroups);
   var actions = $Signal.channel($Update.Noop);
   var htmlGroupClick = _P.portOut("htmlGroupClick",
   ...
   var htmlToggleClick = _P.portOut("htmlToggleClick",
   _P.outgoingSignal(function (v) {
      return v;
   }),
   function () {
   ...
   var repostClick = _P.portOut("repostClick",
   _P.outgoingSignal(function (v) {
      return [{id: v._0.id
              ,text: v._0.text
              ,likes: v._0.likes
   ...
   var mainSignal = $Signal.mergeMany(_L.fromArray([$Signal.subscribe(actions)
                                                   ,newGroups
                                                   ,newPosts
                                                   ,newResize
                                                   ,newPostGrpous
   ...
   name) {
      return function () {
         ...
         theme) ? "toggle-btn toggle-btn-checked" : "toggle-btn toggle-btn-normal";
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class(className)
                      ,$Html$Events.onClick(A2($Signal.send,
                      actions,
                      $Update.ChangeToggle(name)))]),
   ...
   group) {
      return function () {
         ...
         _L.fromArray([$Html$Attributes.$class(cls)
                      ...
                      ,$Html$Attributes.title(A2($Basics._op["++"],
                      group.name,
                      A2($Basics._op["++"],
                      " | ",
                      group.screen_name)))
   ...
   photo) {
      ...
      _L.fromArray([$Html$Attributes.$class("mainimg")
                   ...
                   ,$Html$Events.onClick(A2($Signal.send,
                   actions,
                   $Update.OpenImage(A2($Model.Window,
                   post,
                   photo.photo_604))))]),
      _L.fromArray([]));
   });
   ...
   post) {
      return function () {
         ...
         imgs,
         A2($Basics._op["++"],
         A2(getTextBlock,post,openPosts),
         A2($Basics._op["++"],
         getAudios(post),
            ...
            return A2($Html.div,
              ...
              _L.fromArray([A2($Html.p,
                           ...
                           _L.fromArray([$Html$Attributes.$class("close")
                                        ,$Html$Events.onClick(A2($Signal.send,
                                        actions,
                                        $Update.OpenGroupWindow($Model.NoneGroup)))]),
            ...
            return A2($Html.div,
              ...
              _L.fromArray([A2($Html.p,
                           ...
                           _L.fromArray([$Html$Attributes.$class("close")
                                        ,$Html$Events.onClick(A2($Signal.send,
                                        actions,
                                        $Update.OpenFriendWindow($Model.NoneFriend)))]),
                           _L.fromArray([$Html.text("Закрыть")]))]))
                           ,A2($Html.div,
                           _L.fromArray([$Html$Attributes.$class("friend_container")]),
                           A2($Basics._op["++"],
      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 1) > 0 ? _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                             ,_0: "cursor"
                                                                             ,_1: "pointer"}]))
                 ...
                 _L.fromArray([A2($Html.p,
                              ...
                              _L.fromArray([$Html$Attributes.$class("close")
                                           ,$Html$Events.onClick(A2($Signal.send,
                                           actions,
                                           $Update.OpenImage($Model.None)))]),
                              _L.fromArray([$Html.text("Закрыть")]))]))
                              ,A2($Html.img,
                              A2($Basics._op["++"],
                              _L.fromArray([$Html$Attributes.$class("win_img")
      ...
      return function () {
         ...
         {case "::":
            return _U.eq(f(arr._0),
              elem) ? f($List.head(A2($Basics._op["++"],
              arr._1,
              all))) : A4(getNext,
              all,
              arr._1,
